...
<div class="card shadow mb-4">
	<div class="card-header py-3"><h6 class="m-0 font-weight-bold text-primary">EDITAR</h6></div>

	<div class="card-body">


		    <form class="form-horizontal" action="{{url('estadoconfig')}}/{{$estado->id}}" method="POST">
		    	@method('PATCH')
		    @csrf
		    	<div class="row">
		    		<div class="col-md-8">
...
{{$color->nombre==$estado->color ? 'checked': ''}}
						>
